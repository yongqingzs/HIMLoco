...
```
```bash
python3 /workspace/HIMLoco/legged_gym/legged_gym/scripts/train.py --headless --task go1_trot --max_iterations 5000 --seed 1 --num_envs 4096 --run_name base2
```
...
```
```bash
python3 /workspace/HIMLoco/legged_gym/legged_gym/scripts/train.py --headless --task go1_trot --max_iterations 5000 --seed 1 --num_envs 4096 --run_name base3
```